...
The Fourier series model is more accurate when examine the Cross-Validation values compared to the Cross-Validation values of the model which utilized dummy variables. 